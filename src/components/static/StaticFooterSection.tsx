...
export default function StaticFooterSection({ t }: StaticFooterSectionProps) {
  const services = [
    ...
    { id: 3, label: t('services.service3.title'), href: '/?section=service-3' },
    { id: 4, label: t('services.service4.title'), href: '/?section=service-4' },
    { id: 5, label: t('services.service5.title'), href: '/?section=service-5' },
  ]

  const navigation = [
    { label: t('header.nav.us'), href: '/?section=mi' },
    { label: t('header.nav.services'), href: '/?section=services' },
    { label: t('header.nav.socialRole'), href: '/?section=social' },
    { label: t('header.nav.contribute'), href: '/?section=contribute' },
    { label: t('header.nav.location'), href: '/?section=location' },
  ]
  ...
  return (
    <section id="footer" className="relative bg-[#0b0b0b] text-white">
      <div
        ...
        style={{ backgroundImage: "url('/footer.jpg')", backgroundPosition: 'bottom center' }}
      />
      ...
      <div className="relative z-10 max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 pt-[80px] pb-6 sm:pb-7 md:pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-8 sm:gap-10 md:gap-12 lg:gap-8 xl:gap-10">
          ...
          <div className="min-w-0">
            <p className="font-montserrat text-[16px] sm:text-[0.9375rem] md:text-[1rem] font-semibold tracking-[0.005em] mb-3 sm:mb-4 text-[#FBFBF9]">
              {t('footer.contacts')}
            </p>
            <div className="space-y-2 sm:space-y-3 text-[16px] leading-[1.5] tracking-[0.005em] text-[#FBFBF9] font-montserrat font-normal">
              <div className="flex flex-col items-start gap-1 sm:gap-2">
                <a
                  ...
                  className="hover-bold-no-shift font-montserrat text-[#FBFBF9] transition-colors block break-words"
                  data-text="+38 (067) 370 83 36"
                >
                  <span>+38 (067) 370 83 36</span>
                </a>
                <a
                  href="mailto:spravzhni.lviv@gmail.com"
                  className="hover-bold-no-shift font-montserrat text-[#FBFBF9] transition-colors block break-words sm:inline-block"
                  data-text="spravzhni@gmail.com"
                >
              ...
              <a
                href="https://maps.app.goo.gl/ezZ6YNghBLqv97D89"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-[#FBFBF9] transition-colors"
              >
                <span className="w-[30px] h-[30px] relative hover:opacity-80 transition-opacity">
                  <img
                    src="/images/footer/contact-map.svg"
                    alt="Location"
                    className="w-full h-full object-contain"
                  />
                </span>
                <span
                  className="hover-bold-no-shift font-montserrat font-normal underline underline-offset-2 text-[16px] leading-[1.5] tracking-[0.005em] whitespace-nowrap text-[#FBFBF9] transition-colors"
                  data-text={t('directions.address.value')}
                >
            ...
            <ul className="space-y-2 text-[16px] leading-[1.5] tracking-[0.005em] text-[#FBFBF9] font-montserrat font-normal">
              {services.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    className="hover-bold-no-shift font-montserrat text-[#FBFBF9] transition-colors"
          ...
          <div className="min-w-0">
            <p className="font-montserrat text-[16px] sm:text-[0.9375rem] md:text-[1rem] font-semibold tracking-[0.005em] mb-3 sm:mb-4 lg:whitespace-nowrap text-[#FBFBF9]">
              {t('footer.navigate')}
            </p>
            <ul className="space-y-2 text-[16px] leading-[1.5] tracking-[0.005em] text-[#FBFBF9] font-montserrat font-normal">
              {navigation.map((item) => (
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center justify-start gap-2 sm:gap-3 pl-0 pr-5 md:px-0">
                <span className="font-montserrat text-[16px] md:text-[16px] leading-[1.5] tracking-[0.005em] text-[#FBFBF9] font-normal">
                  {t('footer.followUs')}
                </span>
                <a
                ...
                >
                  <img src="/images/footer/instw.svg" alt="Instagram" className="w-full h-full object-contain" />
                </a>
                <a
                  ...
                  className="w-[26px] h-[26px] relative hover:opacity-80 transition-opacity"
                >
                  <img src="/images/footer/fbw.svg" alt="Facebook" className="w-full h-full object-contain" />
                </a>
                <a
                ...
                >
                  <img src="/images/footer/youtube.svg" alt="YouTube" className="w-full h-full object-contain" />
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start">
              <div className="flex flex-wrap items-center justify-start gap-1 mb-1">
                ...
                <span
                  className="font-montserrat font-light text-[0.75rem] sm:text-[0.8125rem] md:text-[0.875rem] text-[#FBFBF9]"
                  style={{ fontWeight: 300 }}
                >
                  .
                </span>
              ...
              <p
                className="font-montserrat font-light text-left text-[0.75rem] sm:text-[0.8125rem] md:text-[0.875rem] text-[#FBFBF9] leading-[1.3]"
                style={{ fontWeight: 300 }}
              >
                {t('footer.rights')}
              </p>
