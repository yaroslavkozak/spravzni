...
export default function StaticSupportCaptionSection({ t }: StaticSupportCaptionSectionProps) {
  return (
    <section
      id="social"
      className="relative w-full h-[562px] sm:h-[80vh] lg:h-screen overflow-hidden text-white sm:px-6 lg:px-8"
    >
      <div
        className="absolute inset-0 w-full h-full bg-cover bg-[60%_center] bg-no-repeat sm:bg-center"
      ...
      <div className="relative z-10 h-full flex items-start pt-[38px] sm:pt-12 md:pt-16 lg:pt-20 xl:pt-24 px-[22px] sm:px-0">
        <div className="max-w-[40rem] pl-0 sm:pl-6 md:pl-8 lg:pl-10 xl:pl-12">
