...
export const translationsByLanguage: TranslationsByLanguage = {
  uk: {
    ...
    'report.title': 'Звіт фінансової діяльності',
    ...
    'vacationOptions.overlay': 'чекаємо з квітня',
    ...
    'footer.rights': '© 2025 Справжні. Усі права захищені.',
    ...
    'form.consent.prefix': 'Натискаючи Надіслати, ви погоджуєтесь з',
    'form.consent.terms': 'умовами користування',
    'form.consent.and': 'та',
    'form.consent.privacy': 'політикою конфіденційності',
    ...
    'donate.back': 'Назад',
    'donate.title': 'Зроби внесок',
    'donate.subtitle': 'на відновлення та інтеграцію ветеранів від центру «Справжні»',
    ...
    'donate.reportLink': 'Звіт станом на 30 січня 2026 року.',
    'donate.bankDetailsTitle': 'Реквізити для переказу',
  ...
  en: {
    ...
    'vacationOptions.overlay': 'available from April',
    ...
    'donate.reportLink': 'Report as of January 30, 2026.',
