  ...
  return (
    <main className="min-h-screen bg-[#FBFBF9]">
      <style>{`
        ...
        .privacy-page header .text-white:not(button[class*="28694D"] *),
        .privacy-page header svg.text-white:not(button[class*="28694D"] *),
        .privacy-page header a.text-white:not(button[class*="28694D"] *),
        .privacy-page header span.text-white:not(button[class*="28694D"] *),
        ...
        .privacy-page header img[alt="Logo"] {
          filter: brightness(0) !important;
        }
        .privacy-page header img[alt="Menu"] {
          filter: brightness(0) !important;
        }
        .privacy-page header button[aria-label="Toggle menu"] {
          color: #111111 !important;
        }
        .privacy-page header button[aria-label="Toggle menu"] svg {
          stroke: #111111 !important;
          color: #111111 !important;
        }
        .privacy-page header button[aria-label="Toggle menu"] img {
          filter: brightness(0) !important;
        }
        .privacy-page header .backdrop-blur-header {
          backdrop-filter: blur(10px) !important;
          -webkit-backdrop-filter: blur(10px) !important;
        }
        .privacy-page header > div > div[class*="max-w"] {
          background: transparent !important;
        }
        .privacy-page header svg {
          stroke: #111111 !important;
          color: #111111 !important;
        }
        .privacy-page header svg path {
          stroke: #111111 !important;
          fill: #111111 !important;
        }
        .privacy-page header img[src*="icon"],
        .privacy-page header img[src*="Icon"] {
          filter: brightness(0) !important;
        }
        .privacy-page header button:not([class*="28694D"]) span {
          color: #111111 !important;
        }
      `}</style>
      ...
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 pb-12 sm:pb-16 md:pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none font-montserrat text-[#111111] text-[16px] leading-[1.6em] space-y-6">
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section1.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section2.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section3.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section4.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section5.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section6.title')}</h2>
              <p>
            ...
            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section7.title')}</h2>
              <p>
                {t('privacy.section7.body')}
              </p>
              <p className="mt-2">
                {t('privacy.section7.emailLabel')} <a href="mailto:spravzhni.lviv@gmail.com" className="text-[#28694D] hover:underline">spravzhni.lviv@gmail.com</a>
              </p>
              <p>
                {t('privacy.section7.phoneLabel')} <a href="tel:+380673708336" className="text-[#28694D] hover:underline">+38 (067) 370 83 36</a>
              </p>
            </section>

            <section>
              <h2 className="font-bold text-[16px] mb-4">{t('privacy.section8.title')}</h2>
              <p>
                {t('privacy.section8.body')}
              </p>
              <p className="mt-4 text-[14px] text-[#666]">
                {t('privacy.lastUpdated')} {new Date().toLocaleDateString(language === 'uk' ? 'uk-UA' : 'en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
              </p>
            </section>
          </div>
        </div>
